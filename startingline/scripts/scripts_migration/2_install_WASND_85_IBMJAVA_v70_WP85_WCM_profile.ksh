...
<agent-input>
    ...
    <profile id='IBM WebSphere Portal Server V8.5' installLocation='/optware/IBM_85prf/WebSphere/PortalServer'>
        <data key='eclipseLocation' value='/optware/IBM_85prf/WebSphere/PortalServer'/>
        <data key='user.was.installLocation,com.ibm.websphere.PORTAL.SERVER.v85' value='/optware/IBM_85prf/WebSphere/AppServer'/>
        <data key='user.configengine.binaryLocation,com.ibm.websphere.PORTAL.SERVER.v85' value='/optware/IBM_85prf/WebSphere/ConfigEngine'/>
        <data key='user.wp.wasprofiles.location,com.ibm.websphere.PORTAL.SERVER.v85' value='/optware/IBM_85prf/WebSphere/AppServer/profiles'/>
        ...
        <data key='user.wp.hostname,com.ibm.websphere.PORTAL.SERVER.v85' value='pdwpnddev01'/>
        <data key='user.wp.cellname,com.ibm.websphere.PORTAL.SERVER.v85' value='myCell'/>
        <data key='user.wp.nodename,com.ibm.websphere.PORTAL.SERVER.v85' value='myNode'/>
        ...
        <data key='user.wp.profilepath,com.ibm.websphere.PORTAL.SERVER.v85' value='/optware/IBM_85prf/WebSphere/wp_profile'/>
    </profile>
