...
cat > /tmp/IBM_HTTPServer_install.xml <<EOF
...
<profile id='IBM HTTP Server V8.5' installLocation='/optware/IBM/HTTPServer'>
    <data key='eclipseLocation' value='/optware/IBM/HTTPServer'/>
...
./imcl \
    -acceptLicense \
    -input /tmp/IBM_HTTPServer_install.xml \
