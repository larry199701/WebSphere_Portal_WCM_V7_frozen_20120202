...
<agent-input>
    ...
    <profile id='IBM WebSphere Portal Server V8.5' installLocation='/optware/IBM85/WebSphere/PortalServer'>
        ...
        <data key='user.wp.hostname,com.ibm.websphere.PORTAL.SERVER.v85' value='pdwpappprd04'/>
        <data key='user.wp.cellname,com.ibm.websphere.PORTAL.SERVER.v85' value='pdwpndprd01Cell'/>
        <data key='user.wp.nodename,com.ibm.websphere.PORTAL.SERVER.v85' value='pdwpappprd04Node1'/>
