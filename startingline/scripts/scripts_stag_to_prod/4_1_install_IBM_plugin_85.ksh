...
<profile id='Web Server Plug-ins for IBM WebSphere Application Server V8.5' installLocation='/optware/IBM85/WebSphere/Plugins'>
    <data key='eclipseLocation' value='/optware/IBM85/WebSphere/Plugins'/>
